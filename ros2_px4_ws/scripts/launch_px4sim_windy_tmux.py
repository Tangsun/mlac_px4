...
if __name__ == "__main__":
    ...
    command_list = [
        ...
        f"echo '>>> Starting PX4 SITL (gz_x500)...'; cd ~/mlac_px4/px4_src/PX4-Autopilot && PX4_GZ_WORLD={world_name} make px4_sitl gz_x500; exec bash",
        # "echo '>>> Starting PX4 SITL (gz_x500)...'; cd ~/mlac_px4/px4_src/PX4-Autopilot && make px4_sitl gz_x500_windy; exec bash",
        ...
        "sleep 25; echo '>>> Running ROS 2 setpoint_publisher...'; cd ~/mlac_px4/ros2_px4_ws && source install/setup.bash && ros2 run basic_offboard setpoint_publisher; exec bash",
